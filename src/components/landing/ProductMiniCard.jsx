      ...
      <li className='flex flex-col p-2 lg:p-4 gap-10 m-2 w-52 items-center justify-between place-s rounded-xl select-none'>
        ...
        <div className='flex w-full justify-between items-center text-center'>
          ...
          <button
            ...
            className='flex text-center justify-center items-center w-16 h-8 p-1 rounded-xl border-2 border-tabasco-red bg-tabasco-red hover:bg-tabasco-red-dark hover:border-black active:bg-tabasco-red-light active:border-black text-white text-lg xl:text-lg'
          >
    ...
    return (
      ...
      <li className='flex gap-4 p-2 mb-2 w-full items-center rounded-xl bg-black select-none'>
        ...
        >
          ...
          <p className='text-base text-birch-wood hover:text-white'>
            ⓘ Toca para ver más
          </p>
        </div>
