    ...
    return (
      <div className='flex absolute flex-col justify-between w-64 h-96 xl:w-[310px] xl:h-[424px] top-40 right-5 bg-black p-6 text-left '>
        ...
        <div className='flex flex-col gap-2.5'>
          <CustomLink className='flex bg-[#a6121f] border-[#a6121f]  border-2 place-content-center rounded-xl text-white p-2' onClick={scrollToTop} to="/store">
            <p className="text-sm xl:text-lg">TIENDA</p>
          </CustomLink>
          <CustomLink className='flex border-[#a6121f]  border-2 place-content-center rounded-xl text-white p-2' onClick={scrollToTop} to="/login">
